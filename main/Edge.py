...
class Edge:
    def __init__(self, starting_node, ending_node, travel_distance):
        ...
        if not isinstance(starting_node, Node):
            raise DataTypeError(f"Parameter 'starting_node' should be of type 'Node', but got a different type",
                                None, Node, type(starting_node))
        ...
        if not isinstance(ending_node, Node):
            raise DataTypeError("Parameter 'ending_node' should be of type 'Node', but got a different type",
                                None, Node,type(ending_node))
        ...
        if not isinstance(travel_distance, int):
            raise DataTypeError("Parameter 'travel_distance' should be of type 'int', but got a different type",
                                None, int, type(travel_distance))
